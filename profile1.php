...
<body style="font-family:tahoma;background-color:#d0d8e4;">
	...
	<div id="change_profile_image" style= "display:none;position:absolute;width:100%;height:100%;background-color:#000000aa;">
		...
		<div style="max-width:600px;margin:auto;min-height:400px;flex:2.5; padding:20px; padding-right:0px;">
			...
			<form method= "post" action="profile1.php?change=profile"  enctype="multipart/form-data">

	    		<div style="border:solid thin #aaa; padding:10px; background-color:white";>
	    			<input type="file" name="file" >
	    			<input type="submit" id="post_button" style="width:120px;" value="Change">
	    			<br>
	...
	<div id="change_cover_image" style= "display:none;position:absolute;width:100%;height:100%;background-color:#000000aa;">
		...
		<div style="max-width:600px;margin:auto;min-height:400px;flex:2.5; padding:20px; padding-right:0px;">
			...
			<form method= "post" action="profile1.php?change=cover" enctype="multipart/form-data">
	...
	<div style="width:800px; margin:auto;min-height:400px;">
		...
		<div style="background-color:white; text-align:center; color:#405d9b">
		 	...
		 	<span style="font-size:12px">
		 		...
		 		<a onclick="show_change_cover_image(event)" style="text-decoration:none;color:#f0f;" href="change_profile_image.php?change=cover">Change Cover Image</a>
		 	</span>

		 	<br>
		 		<div style="font-size:20px">
		 			<a href ="profile1.php?id=<?php echo $user_data['userid'] ?>">
			...
			<a href="index.php" style="color:#405d9b" ><div id="menu_buttons">Timeline</div></a>
			<a href="profile1.php?section=about" style="color:#405d9b" ><div id="menu_buttons"> About</div></a>
			<a href="profile1.php?section=followers&id=<?php echo $user_data['userid'] ?>" style="color:#405d9b" ><div id="menu_buttons">Followers</div></a>
			<a href="profile1.php?section=following&id=<?php echo $user_data['userid'] ?>" style="color:#405d9b" ><div id="menu_buttons">Following</div></a>
			<a href="profile1.php?section=photos&id=<?php echo $user_data['userid'] ?>" style="color:#405d9b" ><div id="menu_buttons">Photos</div></a>

			<?php
			if($user_data['userid'] == $_SESSION['mybook_userid'])
		    	{
		    	echo '<a href="profile1.php?section=settings&id='. $user_data['userid'].'"><div id="menu_buttons">Settings</div></a>';
		        }
