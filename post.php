	    			...
	    			<div id="post">
	    				...
	    				<div style="width:100%;" >
		    				<div style="font-weight:bold;color:#405d9b; width:100%;">
		    					<?php
		    						echo "<a href='profile1.php?id=$ROW[userid]' >"; 
		    				...
		    				if($ROW['likes']>0)
		    				{
		    					...
		    					else
		    					{
		    						if($i_liked)
		    						{
		    							...
		    							echo "<div style='text-align:left;'> You and " . ($ROW['likes'] - 1)." " . "$text likes this post </div>";
		    							}
		    						}
		    						else 
		    						{
		    						...
		    						echo "<div style='text-align:left;'>" .$ROW['likes'] . " other likes this post </div>";
