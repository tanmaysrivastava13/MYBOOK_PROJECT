	...
	<div style="padding:20px; max-width:350px;display:inline-block;">
		...
		<form method="post" enctype="multipart/form-data" >
				...
				<?php
					...
					echo "<input type='text' id='textbox' name='first_name' value='".htmlspecialchars($settings['first_name'])."' placeholder='First_name' /> ";
					echo "<input type='text' id='textbox' name='last_name' value='".htmlspecialchars($settings['last_name'])."' placeholder='Last_name' /> ";
